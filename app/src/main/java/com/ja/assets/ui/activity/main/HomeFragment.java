...
import com.ja.assets.new_code.bussiness.caigou.CaigouGuanliActivity;
import com.ja.assets.new_code.bussiness.caigou.CaigoujiluActivity;
    ...
    private void initAdapter() {
        ...
        homeAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            switch (homeList.get(position).getPosition()) {
                ...
                case 0:
                    //采购申请
                    intent = new Intent(mainActivity, CaigouGuanliActivity.class);
                    startActivity(intent);
                    break;

                case 1: //采购记录
                    intent = new Intent(mainActivity, CaigoujiluActivity.class);
                    startActivity(intent);
                    break;
                case 2://报修申请
                    intent = new Intent(mainActivity, BaoxiuGuanliActivity.class);
                    startActivity(intent);
                    break;
                case 3:  //报修记录
                    intent = new Intent(mainActivity, BaoxiujiluActivity.class);
                    startActivity(intent);
                    break;
                case 4: //处置申请
                    intent = new Intent(mainActivity, ChuzhiGuanliActivity.class);
                    startActivity(intent);
                    break;
                case 5://处置记录
                ...
                case 7: //盘点记录
                    ...
                    break;
                case 8://调配申请
                    intent = new Intent(mainActivity, DiaoPeiGuanliActivity.class);
                    startActivity(intent);
