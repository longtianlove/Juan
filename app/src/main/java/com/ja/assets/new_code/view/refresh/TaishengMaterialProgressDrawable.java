 ...
 */
public class TaishengMaterialProgressDrawable extends Drawable implements Animatable {
...
//            R.color.refresh_color
    ...
    public TaishengMaterialProgressDrawable(Context context, View parent) {
        mParent = parent;
