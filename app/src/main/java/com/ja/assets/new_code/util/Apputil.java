...
public class Apputil {
    ...
    public static String sdNormalPath = Environment.getExternalStorageDirectory().getPath() + "/Android/data/" + Apputil.getPackageName(JavaApplication.mcontext);
    ...
    public static int getVersionCode() {
        int versionCode = 0;
        PackageManager pm = JavaApplication.mcontext.getPackageManager();
        try {
            PackageInfo pi = pm.getPackageInfo(getPackageName(JavaApplication.mcontext), 0);
