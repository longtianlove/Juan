...
public class Jilu_PatrolCheckDetailActivity extends Activity {
    ...
    void initView() {
        ...
        ll_tijiaotupian.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new PhotoUtils().pickImage(Jilu_PatrolCheckDetailActivity.this, 1, 0);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        switch (requestCode) {
            case 0:
                ...
                LuBanImgUtils luBanImgUtils=new LuBanImgUtils(Jilu_PatrolCheckDetailActivity.this,photoList1.get(0));
