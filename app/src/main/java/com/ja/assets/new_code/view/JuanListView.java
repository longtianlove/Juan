package com.ja.assets.new_code.view;
 ...
 */
public class JuanListView extends ListView implements AbsListView.OnScrollListener {
     ...
     * @param context
     */
    public JuanListView(Context context) {
        this(context, null);
    }

    public JuanListView(Context context, AttributeSet attrs) {
        super(context, attrs);
