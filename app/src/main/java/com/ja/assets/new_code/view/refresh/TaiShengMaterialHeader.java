package com.ja.assets.new_code.view.refresh;
 ...
 */
public class TaiShengMaterialHeader extends View implements PtrUIHandler {


    private TaishengMaterialProgressDrawable mDrawable;
    ...
    public TaiShengMaterialHeader(Context context) {
        super(context);
        initView();
    }

    public TaiShengMaterialHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public TaiShengMaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        mDrawable = new TaishengMaterialProgressDrawable(getContext(), this);
