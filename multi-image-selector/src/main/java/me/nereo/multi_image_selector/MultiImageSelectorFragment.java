...
import me.nereo.multi_image_selector.utils.AppUtils;
    ...
    private void showCameraAction() {
        ...
        if (mTmpFile != null && mTmpFile.exists()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                Uri contentUri = FileProvider.getUriForFile(getActivity(), AppUtils.getPackageName(getActivity()) + ".fileProvider", mTmpFile);
                intent.putExtra(MediaStore.Images.Media.ORIENTATION, REQUEST_CAMERA);
